...
/**
 * Created by Neyomal on 3/6/2017.
 */
...
public class EventsExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public EventsExpandableListAdapter(Context context, List<String> listDataHeader,
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.events_list_childitem, null);
        }
